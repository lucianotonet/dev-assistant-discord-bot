...
async def on_message(message):
    ...
    if isinstance(message.channel, discord.DMChannel) or bot.user.mentioned_in(message):
        await message.channel.send(f'Olá {message.author.name}, sou o Dev Assistant Discord Bot. Estou em desenvolvimento e em breve terei funcionalidades incríveis!')
